...
?>
<div class="searchpoc-teaser">
  <h2><?php print l($detail->getTitle(), 'searchpoc/detail/' . $event->getCdbId()); ?></h2>

  <div class="activity-wrapper">
    <div class="comment-wrapper">
      <?php if ($comment_count > 0): ?>
        <span class="comments"><?php print $comment_count; ?></span> 
        <?php print l('Lees beoordelingen', 'searchpoc/detail/' . $event->getCdbId(), array('fragment' => 'lees')); ?>
        <?php print l('Schrijf beoordeling', 'searchpoc/detail/' . $event->getCdbId(), array('fragment' => 'schrijf')); ?>
      <?php else: ?>
        <span class="no-comments"><?php print $comment_count; ?></span>
        <?php print l('Schrijf als eerste een beoordeling', 'searchpoc/detail/' . $event->getCdbId(), array('fragment' => 'schrijf')); ?>
      <?php endif; ?>
    </div>
    ...
    <?php endif; ?>
    <?php print searchpoc_activity_recommend_link($item); ?>
  </div>
  ...
  <dl class="clearfix">
    ...
    <?php
      $themes = searchpoc_get_categories('theme', $event);
      if (count($themes) > 0):
    ?>
    <dt>Thema</dt>
      <dd>
  ...
  ?>
  <?php print l('Meer info en boeking', 'searchpoc/detail/' . $event->getCdbId(), array('attributes' => array('class' => 'button'))); ?>
