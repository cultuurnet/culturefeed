...
<?php else: ?>
    <?php print t('There are currently no published activities available for your page. Past or unpublished activities can be consulted via <a href="http://www.uitdatabank.be" target="_blank"> UiTdatabank </a>.') ?>
<?php endif; ?>
