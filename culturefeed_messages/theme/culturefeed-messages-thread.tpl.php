...
<p><strong><?php print t('From'); ?>:</strong> <?php print $sender_link; ?> <?php print $sender_page; ?></p>
<p><strong><?php print t('To'); ?>:</strong> <?php print $recipient_links; ?> <?php print $recipient_page; ?></p>
